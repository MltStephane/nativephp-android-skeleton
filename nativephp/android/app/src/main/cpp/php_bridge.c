...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass phpBridgeClass = (*env)->FindClass(env, "com/mltstephane/nutrition/bridge/PHPBridge");
    ...
    jclass laravelEnvClass = (*env)->FindClass(env, "com/mltstephane/nutrition/bridge/LaravelEnvironment");
